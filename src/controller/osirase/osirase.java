...
@WebServlet("/osirase.do")
public class osirase extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<KeisibanVO> list= paging.paging("osirase",cri,query); // 각 게시판 이름 담아서 게시판에 맞게끔 검색
		int count = kutil.noticeAllCount(query,"osirase");
