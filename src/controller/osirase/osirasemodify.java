...
/**
 * Servlet implementation class osirasemodify
 */
@WebServlet("/osirase.modify")
public class osirasemodify extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public osirasemodify() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		KeisibanVO ovo = onepage.selectone(bno, "osirase");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("osirase.read?bno="+bno+"&pagenum="+pagenum+
